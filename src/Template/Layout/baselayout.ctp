<?php 
    ...
    // set the classes according to theme config
...
<html lang="en">
  ...
  <body<?= $bodyClassesHTML ?>>
    ...
    <?= $this->Html->script([
        'KingLoui/BaseKitThemeInspinia./plugins/jquery/dist/jquery.js', 
        'KingLoui/BaseKitThemeInspinia./plugins/bootstrap-sass/assets/javascripts/bootstrap.min.js',
        'KingLoui/BaseKitThemeInspinia./plugins/jquery-slimscroll/jquery.slimscroll.min.js',
        'KingLoui/BaseKitThemeInspinia./plugins/metisMenu/dist/metisMenu.min.js',
